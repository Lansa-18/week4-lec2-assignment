 ...
 */
 ...
 // Contract address of the selfdestruct contract = 0x43f1ddbe9bec683346853a8798f72458856178e2

contract SelfDestructContract {
    address public constant ETHER_VAULT = 0x6dA826f51c447354f65A7480e5364672785C0417;
    ...
    function destroyAndSend() external {
        require(address(this).balance == 0.0005 ether, "Must send exactly 0.0005 ether.");
        selfdestruct(payable(ETHER_VAULT));
    }
